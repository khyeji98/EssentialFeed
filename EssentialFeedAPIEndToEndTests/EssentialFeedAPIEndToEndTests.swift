...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case let .success(items)?:
            XCTAssertEqual(items.count, 8, "Expected 8 items in the test account image feed")
    ...
    private func getImageFeed(file: StaticString = #file, line: UInt = #line) -> LoadFeedResult? {
